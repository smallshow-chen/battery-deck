...
UPDATER_RELEASE_PATH="$RELEASE_DIR/${PRODUCT_SLUG}_${VERSION}_${ARCH}.app.tar.gz"
UPDATER_SIG_RELEASE_PATH="$RELEASE_DIR/${PRODUCT_SLUG}_${VERSION}_${ARCH}.app.tar.gz.sig"
