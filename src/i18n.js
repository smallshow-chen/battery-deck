...
const TRANSLATIONS = {
  en: {
    ...
    "btn.check_updates_now": "Check Now",
    "btn.install_update": "Download and Install",
    "btn.upgrade_helper": "Upgrade Helper",
    "btn.clear_logs": "Clear Logs",
    "btn.coming_soon": "Coming Soon",
    "setting.adapter_sleep": "Sleep prevention preference",
    "setting.adapter_sleep_desc":
      "Saved for future support; automatic sleep prevention is not active yet",
    ...
    "update.status.latest": "You are already on the latest version.",
    ...
    "msg.update_check_complete": "Update check complete",
    "msg.update_install_started": "Update downloaded. Installing now...",
    "msg.helper_upgraded": "Helper upgraded",
    "unsupported.message": "Battery charge control is not supported on this device.",
  ...
  zh: {
    ...
    "btn.check_updates_now": "立即检查",
    "btn.install_update": "下载并安装",
    "btn.upgrade_helper": "升级 Helper",
    "btn.clear_logs": "清理日志",
    "btn.coming_soon": "即将支持",
    "setting.adapter_sleep": "防睡眠偏好",
    "setting.adapter_sleep_desc": "当前仅保存偏好，尚未实际启用自动防睡眠",
    ...
    "update.status.available": "发现可用新版本。",
    "update.status.latest": "当前已是最新版本。",
    ...
    "msg.update_check_complete": "更新检查完成",
    "msg.update_install_started": "更新已下载，正在安装...",
    "msg.helper_upgraded": "Helper 已升级",
    "unsupported.message": "此设备不支持电池充电控制。",
